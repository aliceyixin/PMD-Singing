...
class PMDModel(sb.Brain):
    def __init__(self, label_encoder, **kwargs):
        super(PMDModel, self).__init__(**kwargs)
    ...
    def fit_batch(self, batch):
        ...
        if self.auto_mix_prec:
            ...
            # ## show gradients
            # outputs['embedding_z_ssinger'].retain_grad()
            # outputs['embedding_r_ssinger'].retain_grad()
            # outputs['embedding_z_tsinger'].retain_grad()
            # outputs['embedding_r_tsinger'].retain_grad()
    ...
    def on_fit_start(self):
        super(PMDModel, self).on_fit_start()
